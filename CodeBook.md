...
##Data source
-------------
This dataset is derived from the "Human Activity Recognition Using Smartphones Data Set" which was originally avaiable in: http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones
...
##Data processing to create the final Tidy data 
-----------------------------------------------
